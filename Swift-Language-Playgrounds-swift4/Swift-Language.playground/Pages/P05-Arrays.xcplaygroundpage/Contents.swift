...
var lastItem: String = mutableGroceryList[mutableGroceryList.count-1]
print(lastItem)
/*:
...
*/
var farmLife = ["Wake up", "Wash the dishes", "Milk the cows"]  //1
farmLife.append("Churn butter")                                 //2
farmLife += ["Call the Cows", "Shear the Sheep"]                //3
print(farmLife[0])                                              //4
var currentTask = 0                                             //5
print(farmLife[currentTask])                                    //6
currentTask += 1                                                //7
print(farmLife[currentTask])                                    //8
farmLife.insert("Feed the Chickens", at: 2)                     //9
currentTask += 1                                                //10
print(farmLife[currentTask])                                    //11
print(farmLife)                                                 //12
