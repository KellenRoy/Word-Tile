...
var rect = area(height: 3, width: 2)
print(rect)
...
var rect2 = perimeter(height: 2, width: 3)
print(rect2)

//3
func perimeter2( intList: [Int]) ->  Int{
    var total = 0
    for num in intList{
        total += num
    }
 ...
 var shape = perimeter2(intList: [1, 2, 3, 4, 5])
print(shape)

//4
func nameChecker( nameList: [String], prefix: String) -> [String]?{
    var newArray = [String]()
...
print(nameChecker(nameList: ["Buffy", "Xander", "Willow", "Rupert", "Anya", "Spike", "Tara", "Angel"], prefix: "A"))
/*:
 ### Answers
 */
/*
